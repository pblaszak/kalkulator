<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="logged.php" class="brand-link">
		<img src="../../dist/img/calc.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
		<span class="brand-text font-weight-light">Kalkulator Spalania</span>
	</a>
